"""Static smoke test for v208 backend admin route response helper cleanup.
...
assert_true('"splitStatus": "route-response-helper-v208"' in contract, "backend contract splitStatus should be v208")
...
assert_true('const VERSION = "v208.backend-admin-route-response-helper"' in entry, "frontend readiness version should be v208")
assert_true('splitStatus: "route-response-helper-v208"' in entry, "frontend splitStatus should be v208")
