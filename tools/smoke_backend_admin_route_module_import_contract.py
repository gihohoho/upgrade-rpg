...
assert_true(split_readiness["splitStatus"] == "admin-route-module-import-contract-v224", "splitStatus should be v224")
...
assert_true('const VERSION = "v224.backend-admin-route-module-import-contract"' in entry_source, "frontend readiness version should be v224")
assert_true('splitStatus: "admin-route-module-import-contract-v224"' in entry_source, "frontend splitStatus should be v224")
