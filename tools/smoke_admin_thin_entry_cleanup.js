...
assert(sandbox.RpgAdminReadOnlyPage.VERSION === "v241.backend-admin-validation-error-compatibility-contract", "RpgAdminReadOnlyPage should expose v216 version");
