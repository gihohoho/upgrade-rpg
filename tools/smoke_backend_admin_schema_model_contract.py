...
assert_true('const VERSION = "v244.backend-admin-request-header-encoding-compatibility-contract"' in entry_text, "frontend readiness version should be v238.1.1")
