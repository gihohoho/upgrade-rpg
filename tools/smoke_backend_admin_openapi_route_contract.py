...
assert_true('"splitStatus": "admin-response-metadata-contract-v232"' in contract, "backend split contract should be v230")
...
assert_true('const VERSION = "v232.backend-admin-response-metadata-contract"' in entry, "frontend readiness version should be v230")
assert_true('splitStatus: "admin-response-metadata-contract-v232"' in entry, "frontend splitStatus should be v230")
