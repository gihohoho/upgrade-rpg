...
assert_true('"splitStatus": "admin-runtime-route-contract-v226"' in contract, "backend split contract should be v226")
...
assert_true('const VERSION = "v226.backend-admin-runtime-route-contract"' in entry, "frontend readiness version should be v226")
assert_true('splitStatus: "admin-runtime-route-contract-v226"' in entry, "frontend splitStatus should be v226")
