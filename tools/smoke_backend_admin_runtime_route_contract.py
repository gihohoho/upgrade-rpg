...
assert_true('"splitStatus": "admin-route-operation-contract-v228"' in contract, "backend split contract should be v226")
...
assert_true('const VERSION = "v228.backend-admin-route-operation-contract"' in entry, "frontend readiness version should be v226")
assert_true('splitStatus: "admin-route-operation-contract-v228"' in entry, "frontend splitStatus should be v226")
