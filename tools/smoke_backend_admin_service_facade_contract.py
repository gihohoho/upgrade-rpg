...
assert_true(split_readiness["splitStatus"] == "admin-openapi-route-contract-v230", "splitStatus should be v222")
...
assert_true('const VERSION = "v230.backend-admin-openapi-route-contract"' in entry_source, "frontend readiness version should be v222")
assert_true('splitStatus: "admin-openapi-route-contract-v230"' in entry_source, "frontend splitStatus should be v222")
