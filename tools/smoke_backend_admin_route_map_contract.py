...
assert_true('"splitStatus": "admin-service-legacy-marker-cleanup-v220"' in contract, "backend split contract should be v218")
...
assert_true('const VERSION = "v220.backend-admin-route-service-legacy-cleanup"' in entry, "frontend readiness version should be v218")
assert_true('splitStatus: "admin-service-legacy-marker-cleanup-v220"' in entry, "frontend splitStatus should be v218")
