...
assert_true('"splitStatus": "admin-openapi-route-contract-v230"' in contract, "backend split contract should be v224")
...
assert_true('const VERSION = "v230.backend-admin-openapi-route-contract"' in entry, "frontend readiness version should be v224")
assert_true('splitStatus: "admin-openapi-route-contract-v230"' in entry, "frontend splitStatus should be v224")
