...
assert(adminJs.includes('v153.admin-relation-preview-tools'), 'admin page version is v134 safe selects');
assert(adminHtml.includes('v153 admin relation preview tools'), 'admin footer is v134 safe selects');
