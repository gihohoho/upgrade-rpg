...
assert(adminJs.includes('v156.admin-change-log-relation-tools'), 'admin page version is v134 safe selects');
assert(adminHtml.includes('v156 admin change log relation tools'), 'admin footer is v134 safe selects');
