...
assert(adminJs.includes('v162.admin-create-draft-preview'), 'admin page version is v134 safe selects');
assert(adminHtml.includes('v162 admin create draft preview'), 'admin footer is v134 safe selects');
