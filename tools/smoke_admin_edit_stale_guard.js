...
assert(adminJs.includes('v147.admin-owner-code-relation-tools'), 'admin page version is v134 safe selects');
assert(adminHtml.includes('v147 admin owner code relation tools'), 'admin footer is v134 safe selects');
