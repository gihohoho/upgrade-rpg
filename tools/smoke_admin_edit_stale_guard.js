...
assert(adminJs.includes('v159.admin-create-blueprint-readonly'), 'admin page version is v134 safe selects');
assert(adminHtml.includes('v159 admin create blueprint readonly'), 'admin footer is v134 safe selects');
