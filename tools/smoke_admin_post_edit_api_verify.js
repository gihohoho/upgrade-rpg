...
assert(adminJs.includes('v138.admin-safe-apply-review'), 'version should be v128');
...
assert(adminHtml.includes('v138 admin safe apply review'), 'footer should be v128');
