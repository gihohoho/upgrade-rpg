...
assert(adminJs.includes('v128.admin-post-edit-api-verify'), 'version should be v128');
...
assert(adminHtml.includes('v128 admin post-edit API verify'), 'footer should be v128');
