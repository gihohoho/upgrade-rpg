...
assert(adminJs.includes('v159.admin-create-blueprint-readonly'), 'version should be v128');
...
assert(adminHtml.includes('v159 admin create blueprint readonly'), 'footer should be v128');
