...
assert(adminJs.includes('v141.admin-relation-safe-edit'), 'version should be v128');
...
assert(adminHtml.includes('v141 admin relation safe edit'), 'footer should be v128');
