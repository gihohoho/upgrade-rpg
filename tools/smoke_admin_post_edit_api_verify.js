...
assert(adminJs.includes('v162.admin-create-draft-preview'), 'version should be v128');
...
assert(adminHtml.includes('v162 admin create draft preview'), 'footer should be v128');
