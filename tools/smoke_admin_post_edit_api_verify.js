...
assert(adminJs.includes('v130.admin-write-dev-key-guard'), 'version should be v128');
...
assert(adminHtml.includes('v130 admin write dev key guard'), 'footer should be v128');
