...
assert(adminJs.includes('v156.admin-change-log-relation-tools'), 'version should be v128');
...
assert(adminHtml.includes('v156 admin change log relation tools'), 'footer should be v128');
