...
const docs = fs.readFileSync(path.join(root, 'docs/archive/history/ADMIN_AND_BACKEND_HISTORY.md'), 'utf8');
...
assert(adminJs.includes('v165.admin-create-apply-limited'), 'version should be v128');
...
assert(adminHtml.includes('v165 admin create apply limited'), 'footer should be v128');
