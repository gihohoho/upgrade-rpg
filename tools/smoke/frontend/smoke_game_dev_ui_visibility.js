...
function testStaticContracts() {
	...
	assert.match(html, /game-dev-ui-access\.js\?v=402/);
	assert(html.indexOf("game-dev-ui-access.js?v=402") < html.indexOf("main.js?v=402"), "개발 UI access gate는 main.js보다 먼저 로드되어야 합니다.");
