...
VERSION = "v385.vue-game-town-hud-shell"
RESULT = "vue-game-town-hud-shell"
NEXT_STAGE = "migrate-vue-game-field-combat-ui-foundation"
...
def main() -> int:
    ...
    require_markers(
        "NEXT_CHAT_PROMPT.md",
        "migrate-vue-game-field-combat-ui-foundation",
