...
assert_true('const VERSION = "v250.backend-admin-rollback-snapshot"' in entry, "admin page version should be v234")
...
assert_true("tools/smoke/contracts/smoke_backend_admin_request_metadata_contract.py" in run_smoke, "core smoke should run request metadata contract smoke")
