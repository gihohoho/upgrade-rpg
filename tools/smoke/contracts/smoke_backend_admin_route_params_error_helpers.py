...
assert_true("ADMIN_CURRENT_USER_DEP = Depends(require_admin_user)" in params, "authenticated admin dependency helper missing")
assert_true("get_current_user_placeholder" not in params, "admin route params must not use the local placeholder identity")
