...
assert_true("tools/smoke/contracts/smoke_backend_admin_response_metadata_contract.py" in run_smoke, "core smoke should run response metadata contract smoke")
