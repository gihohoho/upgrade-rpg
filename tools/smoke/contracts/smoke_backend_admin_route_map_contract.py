...
legacy_smoke_files = {
    "tools/smoke/frontend/smoke_admin_master_data_catalog.js": "backend/app/api/routes/admin_master_data_routes.py",
    "tools/smoke/frontend/smoke_admin_master_data_detail.js": "backend/app/api/routes/admin_master_data_routes.py",
    "tools/smoke/frontend/smoke_admin_master_data_relations.js": "backend/app/api/routes/admin_master_data_routes.py",
    "tools/smoke/frontend/smoke_admin_edit_draft_validation.js": "backend/app/api/routes/admin_master_data_routes.py",
    "tools/smoke/frontend/smoke_admin_create_apply_limited.js": "backend/app/api/routes/admin_master_data_routes.py",
    "tools/smoke/frontend/smoke_admin_create_delete_rollback.js": "backend/app/api/routes/admin_change_log_routes.py",
    "tools/smoke/frontend/smoke_admin_create_delete_restore.js": "backend/app/api/routes/admin_change_log_routes.py",
    "tools/smoke/frontend/smoke_admin_change_log_rollback.js": "backend/app/api/routes/admin_change_log_routes.py",
    "tools/smoke/frontend/smoke_admin_save_snapshot_filters.js": "backend/app/api/routes/admin_response_data_helpers.py",
}
...
assert_true('const VERSION = "v250.backend-admin-rollback-snapshot"' in entry, "frontend readiness version should be v224")
