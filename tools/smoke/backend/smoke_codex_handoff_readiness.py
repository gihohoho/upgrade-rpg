...
def load_tool():
    spec = importlib.util.spec_from_file_location("v329_codex_handoff", TOOL)
    if spec is None or spec.loader is None:
        raise RuntimeError("cannot load v329 Codex handoff checker")
...
def expect_blocked(module, temp: Path) -> None:
    try:
        ...
        return
    raise AssertionError("unsafe v329 Codex handoff fixture was not blocked")
...
def main() -> int:
    ...
    print("OK: v329 Codex/GHCR recorded provenance failure handoff smoke passed")
    return 0
