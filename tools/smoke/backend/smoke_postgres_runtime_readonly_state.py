...
STATE_DOC = ROOT / "docs/reference/database/POSTGRES_RUNTIME_READONLY_STATE.md"
STRATEGY_DOC = ROOT / "docs/reference/database/POSTGRES_ALEMBIC_BASELINE_STRATEGY.md"
