...
ATTEMPT_HISTORY = [
    ...
    {
        "preparationSha": "36e8720a53ef7ff6a8334de6bc99646998d63fc9",
    ...
    {
        "preparationSha": "b48dfd0751b12b1b3afb6474f9d35359ba2f8177",
        "authorizationSha": "7578eb665c03ee0fcb9399929328ce684cdd1b31",
        "closureSha": "5d547126322dbe3c235e855cc9c2f7337342ae36",
        "recordCommitSha": "5c842deec6d1f496679a144897f485b07428810b",
        "runId": 30226905547,
        "runUrl": "https://github.com/gihohoho/upgrade-rpg/actions/runs/30226905547",
        "conclusion": "success",
        "registryLoginExecuted": True,
        "imageBuildExecuted": True,
        "imagePushExecuted": True,
...
LOCK_SHA256 = {
    ...
    "backend/requirements/runtime-linux-amd64-py311.lock": "126718271e5cf1007487f7813adc648030691b3a251787f6bf570919d02cc05e",
    "backend/requirements/runtime-musllinux-amd64-py311.lock": "a318ee15cf227eb057f1fef1c1df7ff3dc10b65d892e889da3ee9ad747b5ea10",
    "backend/requirements/dev-linux-amd64-py311.lock": "eb97dea783b80fe5187a161eac3cd3298f602d64dabed613a3be5223c81198b7",
}
REPRODUCIBILITY_INPUT_SHA256 = {
    ...
    "backend/requirements/runtime.in": "de3324e5b96538e6d4d768ed980acae3bd6005711eda48702364cf0e2018bfcb",
    "backend/requirements/dev.in": "6404277a75ce651735fcea3f89b5eee548cfd58ee197faed27b03333d587e2fe",
    "backend/pyproject.toml": "066fbc7367508130b329ea31f9715dd95131cf02b64f22011bb025ca4f76ad9e",
...
def render(result: dict[str, Any]) -> str:
    return "\n".join((
        ...
        "- recorded action allowlist/full SHA enforcement: configured/configured (lifecycle evidence)",
        ...
        "- recorded environment/main-only: present/configured (lifecycle evidence)",
