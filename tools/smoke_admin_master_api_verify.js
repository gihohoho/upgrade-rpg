...
assert(adminJs.includes('v133.admin-edit-input-ui'), 'version should be v133 admin edit input UI');
...
assert(adminHtml.includes('v133 admin edit input UI'), 'footer version not updated');
