...
assert(adminJs.includes('v138.admin-safe-apply-review'), 'version should be v138 admin safe apply review');
...
assert(adminHtml.includes('v138 admin safe apply review'), 'footer version not updated');
