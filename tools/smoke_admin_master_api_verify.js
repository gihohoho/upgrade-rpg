...
assert(adminJs.includes('v144.admin-combo-relation-guard'), 'version should be v144 admin combo relation guard');
...
assert(adminHtml.includes('v144 admin combo relation guard'), 'footer version not updated');
