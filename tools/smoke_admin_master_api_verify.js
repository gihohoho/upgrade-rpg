...
assert(adminJs.includes('v156.admin-change-log-relation-tools'), 'version should be v156 admin change log relation tools');
...
assert(adminHtml.includes('v156 admin change log relation tools'), 'footer version not updated');
