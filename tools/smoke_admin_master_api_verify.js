...
assert(adminJs.includes('v141.admin-relation-safe-edit'), 'version should be v141 admin relation safe edit');
...
assert(adminHtml.includes('v141 admin relation safe edit'), 'footer version not updated');
