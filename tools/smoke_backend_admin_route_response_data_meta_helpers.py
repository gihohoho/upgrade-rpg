...
assert_true('"splitStatus": "admin-route-module-import-contract-v224"' in contract, "contract splitStatus should be v216")
assert_true('"No route path changes in v224"' in contract, "route path contract should mention v214")
assert_true('const VERSION = "v224.backend-admin-route-module-import-contract"' in entry, "frontend readiness version should be v216")
assert_true('splitStatus: "admin-route-module-import-contract-v224"' in entry, "frontend splitStatus should be v216")
