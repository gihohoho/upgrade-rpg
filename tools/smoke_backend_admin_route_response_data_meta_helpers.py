...
assert_true('"splitStatus": "admin-response-metadata-contract-v232"' in contract, "contract splitStatus should be v216")
assert_true('"No route path changes in v228"' in contract, "route path contract should mention v214")
assert_true('const VERSION = "v232.backend-admin-response-metadata-contract"' in entry, "frontend readiness version should be v216")
assert_true('splitStatus: "admin-response-metadata-contract-v232"' in entry, "frontend splitStatus should be v216")
