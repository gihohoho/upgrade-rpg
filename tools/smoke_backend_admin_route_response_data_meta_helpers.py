...
assert_true('"splitStatus": "admin-service-legacy-marker-cleanup-v220"' in contract, "contract splitStatus should be v216")
assert_true('"No route path changes in v218"' in contract, "route path contract should mention v214")
assert_true('const VERSION = "v220.backend-admin-route-service-legacy-cleanup"' in entry, "frontend readiness version should be v216")
assert_true('splitStatus: "admin-service-legacy-marker-cleanup-v220"' in entry, "frontend splitStatus should be v216")
