...
assert_true('"splitStatus": "admin-runtime-route-contract-v226"' in contract, "contract splitStatus should be v216")
assert_true('"No route path changes in v226"' in contract, "route path contract should mention v214")
assert_true('const VERSION = "v226.backend-admin-runtime-route-contract"' in entry, "frontend readiness version should be v216")
assert_true('splitStatus: "admin-runtime-route-contract-v226"' in entry, "frontend splitStatus should be v216")
