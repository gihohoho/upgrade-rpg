...
assert_true('"splitStatus": "admin-route-map-contract-v218"' in contract, "contract splitStatus should be v216")
assert_true('"No route path changes in v218"' in contract, "route path contract should mention v214")
assert_true('const VERSION = "v218.backend-admin-route-map-contract"' in entry, "frontend readiness version should be v216")
assert_true('splitStatus: "admin-route-map-contract-v218"' in entry, "frontend splitStatus should be v216")
