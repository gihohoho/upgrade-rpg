...
assert_true('"splitStatus": "admin-openapi-route-contract-v230"' in contract, "contract splitStatus should be v216")
assert_true('"No route path changes in v228"' in contract, "route path contract should mention v214")
assert_true('const VERSION = "v230.backend-admin-openapi-route-contract"' in entry, "frontend readiness version should be v216")
assert_true('splitStatus: "admin-openapi-route-contract-v230"' in entry, "frontend splitStatus should be v216")
