...
def main() -> int:
    ...
    assert_true(readiness["splitStatus"] == "master-catalog-extracted-v200", "unexpected split status")
    ...
    assert_true(readiness["lineCount"] and readiness["lineCount"] >= 2500, "admin_service.py size signal should be present")
