...
def main() -> int:
    ...
    assert_true(readiness["splitStatus"] == "edit-draft-extracted-v203", "unexpected split status")
    ...
    assert_true(readiness["lineCount"] and readiness["lineCount"] < 800, "admin_service.py should be smaller after v203 edit draft split")
