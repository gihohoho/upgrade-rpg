...
def main() -> int:
    ...
    assert_true(readiness["splitStatus"] == "change-logs-extracted-v202", "unexpected split status")
    ...
    assert_true(readiness["lineCount"] and readiness["lineCount"] >= 1000, "admin_service.py size signal should be present")
