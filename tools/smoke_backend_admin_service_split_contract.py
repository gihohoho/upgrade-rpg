...
def main() -> int:
    ...
    assert_true(readiness["splitStatus"] == "shared-utils-extracted-v204", "unexpected split status")
    ...
    assert_true(readiness["lineCount"] and readiness["lineCount"] < 800, "admin_service.py should be smaller after v204 shared utils split")
