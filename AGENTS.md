...
- Vue v380 `npm ci`, `vue-tsc`, production build, Vue focused smoke와 실제 desktop/mobile browser 검증이 PASS했습니다. 다음은 관리자 인증·route guard 이식이며 production 관리자 복구는 별도 DB-write 승인 전까지 보류합니다.
