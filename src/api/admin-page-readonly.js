(function () {
  ...
  const VERSION = "v241.backend-admin-validation-error-compatibility-contract";
...
function getAdminCreateLifecycleApi() {
  ...
  function getAdminBackendServiceSplitContractReadiness() {
    ...
    return {
      ...
      runtimeRequestMetadataReady,
      openApiRequestMetadataReady,
      writeGuardDependencyMetadataReady, schemaModelContractReady, schemaFieldConstraintContractReady, requestPayloadValidationContractReady, validationErrorCompatibilityContractReady,
      routeOwnershipStrictReady,
      routeServiceDependencyReady,
      serviceLegacyMarkersReady,
      serviceFacadeContractReady,
...
async function openAdminMasterDataDetail(...args) {
  ...
  function checkAdminReadOnlyPageReady(options) {
    ...
    const readinessChecks = {
      ...
      backendSchemaFieldConstraintContractReady, backendRequestPayloadValidationContractReady, backendValidationErrorCompatibilityContractReady, backendRouteOwnershipStrictReady, backendRouteServiceDependencyReady,
