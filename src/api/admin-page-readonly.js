(function () {
  ...
  const VERSION = "v240.backend-admin-request-payload-validation-contract";
...
function getAdminCreateLifecycleApi() {
  ...
  function getAdminBackendServiceSplitContractReadiness() {
    ...
    return {
      ...
      runtimeRequestMetadataReady,
      openApiRequestMetadataReady,
      writeGuardDependencyMetadataReady, schemaModelContractReady, schemaFieldConstraintContractReady, requestPayloadValidationContractReady,
      routeOwnershipStrictReady,
      routeServiceDependencyReady,
      serviceLegacyMarkersReady,
      serviceFacadeContractReady,
...
async function openAdminMasterDataDetail(...args) {
  ...
  function checkAdminReadOnlyPageReady(options) {
    ...
    const readinessChecks = {
      ...
      backendSchemaFieldConstraintContractReady, backendRequestPayloadValidationContractReady, backendRouteOwnershipStrictReady, backendRouteServiceDependencyReady,
