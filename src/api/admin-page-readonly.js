(function () {
  ...
  const VERSION = "v242.backend-admin-request-content-negotiation-contract";
...
function getAdminCreateLifecycleApi() {
  ...
  function getAdminBackendServiceSplitContractReadiness() {
    ...
    return {
      ...
      runtimeRequestMetadataReady,
      openApiRequestMetadataReady,
      writeGuardDependencyMetadataReady, schemaModelContractReady, schemaFieldConstraintContractReady, requestPayloadValidationContractReady, validationErrorCompatibilityContractReady, requestContentNegotiationContractReady,
      routeOwnershipStrictReady,
      routeServiceDependencyReady,
      serviceLegacyMarkersReady,
      serviceFacadeContractReady,
...
async function openAdminMasterDataDetail(...args) {
  ...
  function checkAdminReadOnlyPageReady(options) {
    ...
    const readinessChecks = {
      ...
      backendSchemaFieldConstraintContractReady, backendRequestPayloadValidationContractReady, backendValidationErrorCompatibilityContractReady, backendRequestContentNegotiationContractReady, backendRouteOwnershipStrictReady, backendRouteServiceDependencyReady,
