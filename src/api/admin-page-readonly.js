(function () {
  ...
  const VERSION = "v243.backend-admin-request-media-size-boundary-contract";
...
function getAdminCreateLifecycleApi() {
  ...
  function getAdminBackendServiceSplitContractReadiness() {
    ...
    return {
      ...
      runtimeRequestMetadataReady,
      openApiRequestMetadataReady,
      writeGuardDependencyMetadataReady, schemaModelContractReady, schemaFieldConstraintContractReady, requestPayloadValidationContractReady, validationErrorCompatibilityContractReady, requestContentNegotiationContractReady, requestMediaSizeBoundaryContractReady,
      routeOwnershipStrictReady,
      routeServiceDependencyReady,
      serviceLegacyMarkersReady,
      serviceFacadeContractReady,
...
async function openAdminMasterDataDetail(...args) {
  ...
  function checkAdminReadOnlyPageReady(options) {
    ...
    const readinessChecks = {
      ...
      backendSchemaFieldConstraintContractReady, backendRequestPayloadValidationContractReady, backendValidationErrorCompatibilityContractReady, backendRequestContentNegotiationContractReady, backendRequestMediaSizeBoundaryContractReady, backendRouteOwnershipStrictReady, backendRouteServiceDependencyReady,
