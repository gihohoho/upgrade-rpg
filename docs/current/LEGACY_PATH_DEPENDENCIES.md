...
| --- | --- | --- | --- | --- |
| `admin.html` | O | 213 | 90 | 절대 이동 금지 |
| `index.html` | O | 129 | 55 | 절대 이동 금지 |
| `src/` | O | 1121 | 210 | 절대 이동 금지 |
| `src/api/` | O | 644 | 175 | Vue 이식 후보이지만 현 위치 유지 |
| `src/api/admin/` | O | 373 | 136 | Vue 관리자 이식 후보이지만 현 위치 유지 |
| `src/data/` | O | 81 | 28 | DB seed 준비 전 이동 금지 |
| `src/rules/` | O | 33 | 15 | 콘텐츠 개발 보류, 현 위치 유지 |
| `src/state/` | O | 19 | 13 | Vue store 후보, 현 위치 유지 |
| `src/systems/` | O | 64 | 27 | domain module 후보, 현 위치 유지 |
| `src/ui/` | O | 23 | 15 | Vue component 대체 후보, 현 위치 유지 |
| `src/styles/` | O | 25 | 9 | Vue CSS 분해 후보, 현 위치 유지 |
| `backend/app/api/routes/` | O | 351 | 80 | route path/contract 보호 |
| `backend/app/services/` | O | 267 | 96 | service contract 보호 |
| `backend/seeds/` | O | 35 | 15 | 사용자 승인 전 변경 금지 |
| `tools/run_smoke_core.sh` | O | 94 | 77 | 검증 기준 유지 |
| `tools/smoke/` | O | 300 | 126 | 경로 의존성 기준 |
...
| `src/api/admin/` | `CHANGELOG.md`<br>`README.md`<br>`admin.html`<br>`docs/ADMIN_CHANGE_LOGS_SPLIT.md`<br>`docs/ADMIN_CHANGE_LOG_SPLIT_CONTRACT.md`<br>`docs/ADMIN_CREATE_LIFECYCLE_SPLIT.md`<br>`docs/ADMIN_CREATE_LIFECYCLE_SPLIT_CONTRACT.md`<br>`docs/ADMIN_EDIT_DRAFT_SPLIT.md` |
...
| 89 | `python tools/smoke/contracts/smoke_backend_admin_preview_side_effect_contract.py` |
| 90 | `python tools/smoke/contracts/smoke_backend_admin_service_mutation_boundary_contract.py` |
| 91 | `python tools/smoke/contracts/smoke_backend_admin_diff_engine_contract.py` |
| 92 | `python tools/smoke/contracts/smoke_backend_admin_change_log_shared_diff.py` |
| 93 | `python tools/smoke/contracts/smoke_backend_admin_rollback_snapshot_contract.py` |
| 94 | `python tools/smoke/contracts/smoke_backend_admin_rollback_preview_snapshot.py` |
...
| `backend/app/services/game_service.py` | 5 |
| `backend/app/services/admin/admin_create_lifecycle_service.py` | 4 |
