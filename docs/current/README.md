...
- `GITHUB_ACTIONS_GHCR_STATIC_WORKFLOW_PLAN.md`: 최소 permissions, 수동 trigger, supply-chain gate
- `SECURITY_ROTATION_AND_GITHUB_GATES.md`: 계속 적용되는 보안 권한, reviewer 차단, 나중 회전할 항목
