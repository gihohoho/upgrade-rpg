...
- 상세 schema 비교와 FLOAT alias 정규화: `POSTGRES_SCHEMA_EQUIVALENCE_CHECK.md`
- backup/restore preflight와 보존 경계: `POSTGRES_BACKUP_RESTORE_PREP.md`
...
- backend 구조 계획: `BACKEND_STRUCTURE_PLAN.md`
