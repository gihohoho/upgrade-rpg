# Project Structure — v283

현재 ZIP 기준 프로젝트 구조 점검 문서입니다.

v283에서는 legacy/Vue/backend 구조를 유지한 채 PostgreSQL/Alembic readiness 보고서와 로컬 prerequisite checker를 추가했습니다.
...
| `docs/` | 현재 상태/전환 계획/DB 준비/인수인계 문서 | v283 기준 갱신 |
...
## v282~v283 PostgreSQL/Alembic 준비 도구
