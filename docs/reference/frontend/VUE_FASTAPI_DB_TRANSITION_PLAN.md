...
자세한 내용은 `docs/reference/frontend/VUE_READONLY_API_CLIENT.md`를 기준으로 봅니다.
...
다음 단계는 FastAPI app에서 실제 route 목록을 자동 추출해 `docs/generated/BACKEND_ROUTE_MAP.md`를 만드는 것입니다.
