...
local/Neon applied DB revision: v402_server_gameplay / v377_auth_email_public_security
...
local/Neon application tables: 27 / 25
...
| local/Neon DB application table 수 | 27개 / 25개 |
...
- 적용 DB current: local `v402_server_gameplay` / Neon `v377_auth_email_public_security`
