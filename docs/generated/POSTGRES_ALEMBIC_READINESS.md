# PostgreSQL / Alembic Readiness — v371
...
- source revision: 2개 / graph head `v371_email_identity_lifecycle`
- 적용 DB current: `v295_initial_schema` / v371 not applied
