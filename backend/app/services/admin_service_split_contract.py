...
ADMIN_SERVICE_SPLIT_CONTRACT: dict[str, Any] = {
    ...
    "splitGroups": [
        ...
        {
            "key": "request-payload-validation-contract",
            "label": "Admin request payload alias and FastAPI 422 validation contract",
            "candidateFile": "backend/app/api/routes/admin_request_payload_validation_contract.py",
            "publicMethods": [],
            "helperMethods": [],
        },
        {
            "key": "validation-error-compatibility-contract",
            "label": "Admin malformed JSON, empty body, and content-type 422 compatibility contract",
            "candidateFile": "backend/app/api/routes/admin_validation_error_compatibility_contract.py",
            "publicMethods": [],
            "helperMethods": [],
        },
        {
            "key": "request-content-negotiation-contract",
            "label": "Admin request Content-Type, body shape, and Accept negotiation contract",
            "candidateFile": "backend/app/api/routes/admin_request_content_negotiation_contract.py",
            "publicMethods": [],
            "helperMethods": [],
        },
        {
            "key": "request-media-size-boundary-contract",
            "label": "Admin non-JSON media type and request size ownership boundary contract",
            "candidateFile": "backend/app/api/routes/admin_request_media_size_boundary_contract.py",
            "publicMethods": [],
            "helperMethods": [],
        },
        {
            "key": "request-header-encoding-contract",
            "label": "Admin request header and encoding compatibility contract",
            "candidateFile": "backend/app/api/routes/admin_request_header_encoding_contract.py",
            "publicMethods": [],
            "helperMethods": [],
        },
        {
            "key": "write-replay-safety-contract",
            "label": "Admin write replay safety contract",
            "candidateFile": "backend/app/api/routes/admin_write_replay_safety_contract.py",
            "publicMethods": [],
            "helperMethods": [],
        },
        {
            "key": "preview-side-effect-contract",
            "label": "Admin preview side-effect static contract",
            "candidateFile": "backend/app/api/routes/admin_preview_side_effect_contract.py",
            "publicMethods": [], "helperMethods": [],
        },
        {
            "key": "service-mutation-boundary-contract",
            "label": "Admin service mutation boundary contract",
            "candidateFile": "backend/app/api/routes/admin_service_mutation_boundary_contract.py",
            "publicMethods": [], "helperMethods": [],
        },
        {
