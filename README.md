...
현재 안정 버전: **v176 create apply bosses**

새 채팅 인수인계 ZIP: **rpg_v176_bosses_create_apply_ready.zip**
...
`bosses` create apply가 열렸으므로 다음은 실제 브라우저에서 보스 생성/삭제/복원 흐름을 한 번 확인하는 것이 안전합니다. `itemTemplates`, `skills`, `dropTables`, `dropTableItems`는 아직 신규 생성 apply를 열지 않는 것이 좋습니다.
