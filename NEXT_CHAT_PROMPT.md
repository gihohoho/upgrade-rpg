...
현재 안정 버전은 `v244.backend-admin-request-header-encoding-compatibility-contract`이며 backend splitStatus는 `admin-schema-field-constraint-contract-v238`입니다. 기준 ZIP은 `rpg_v244_backend_admin_request_header_encoding_compatibility_contract.zip`입니다.
